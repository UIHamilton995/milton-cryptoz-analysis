        ...
        <tbody>
          {
            cryptoData.map(data => {
              return (
                ...
                <td className='py-4 items-center flex uppercase'>
...
<rect width="30" height="30" fill="white"/>
                  ...
                  <img className='w-[1.5rem] h-[1.5rem] mx-2' src={data.image} alt={data.name} /> 
                  <span>{data.symbol}</span>  
                </td>
                <td className='py-4'>{data.name}</td>
                <td className='py-4 text-amber'>{
                ...
                <td className={data.price_change_percentage_1h_in_currency > 0 ? 'text-cyan py-4' : 'text-red py-4'}>{Number(data.price_change_percentage_1h_in_currency).toFixed(2)}</td>
                <td className={data.price_change_percentage_24h_in_currency > 0 ? 'text-cyan py-4' : 'text-red py-4'}>{Number(data.price_change_percentage_24h_in_currency).toFixed(2)}</td>
                <td className={data.price_change_percentage_7d_in_currency > 0 ? 'text-cyan py-4' : 'text-red py-4'}>{Number(data.price_change_percentage_7d_in_currency).toFixed(2)}</td>
            </tr>
            )
          })  
        }
